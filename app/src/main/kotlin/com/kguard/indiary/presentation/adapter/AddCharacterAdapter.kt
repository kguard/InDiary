...
import com.kguard.indiary.presentation.data.CustomCharacter
...
class AddCharacterAdapter() : RecyclerView.Adapter<AddCharacterAdapter.AddCharacterViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AddCharacterViewHolder {
        val binding =
            ItemCustomCharacterBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class AddCharacterViewHolder(val binding: ItemCustomCharacterBinding) :
